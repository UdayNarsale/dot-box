    ...
    <label className="block">
      ...
      <div className="mt-2 flex items-center gap-2">
        <button
          ...
          className="size-10 rounded-lg border border-slate-200 bg-white text-lg font-semibold hover:bg-slate-50"
  ...
  return (
    <label className="block">
      ...
      <input
        ...
        className="mt-2 w-full rounded-xl border border-slate-200 bg-white px-3 py-2.5 text-sm outline-none focus:ring-2 focus:ring-slate-300"
      />
    </label>
  )
}
